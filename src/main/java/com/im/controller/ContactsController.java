...
//	public TLRPC.TL_contactStatus[] getStatuses(ContactsApi.GetStatuses getStatuses) {
//		return null;
//	}
//
...
//	public TLRPC.Updates deleteContacts(ContactsApi.DeleteContacts deleteContacts) {
//		return null;
//	}
//
...
////	public TLRPC.saved[] getSaved(ContactsApi.GetSaved getSaved) {
////		return null;
////	}
//
...
//	public TLRPC.Updates addContact(ContactsApi.AddContact addContact) {
//		return null;
//	}
//
//	@WebsocketHandlerMapping(value = 0xf831a20f, name = "AcceptContact")
//	public TLRPC.Updates acceptContact(ContactsApi.AcceptContact acceptContact) {
//		return null;
//	}
//
//	@WebsocketHandlerMapping(value = 0xd348bc44, name = "GetLocated")
//	public TLRPC.Updates getLocated(ContactsApi.GetLocated getLocated) {
//		return null;
//	}
//
//	@WebsocketHandlerMapping(value = 0x29a8962c, name = "BlockFromReplies")
//	public TLRPC.Updates blockFromReplies(ContactsApi.BlockFromReplies blockFromReplies) {
//		return null;
//	}
//
